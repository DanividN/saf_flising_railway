...
@section('breadcrumb')
        ...
        <li class="breadcrumb-item" aria-current="page"><span class="rutas"><small>Información de GPS</small></span></li>
@endsection

@section('content')
<div class="container-fluid mt-5">
    <div class="titulo-responsive">
        <label><a>Ver GPS</a></label>
    </div>
        ...
        <div class="card-body">
            ...
            <div class="row mt-3">
                <div class="col-md-4 col-sm-12">
                    ...
                    <input type="text" class="form-control" id="razonSocial" value="{{$gps->razon_gps}}" disabled placeholder="Ingresar razón social">
                </div>
                <div class="col-md-4 col-sm-12">
                    <label for="nombreComercial" class="form-label"><b>Nombre comercial</b></label>
                    <input type="text" class="form-control" id="nombreComercial" value="{{$gps->nombre_gps}}" disabled placeholder="Nombre comercial">
                </div>
                <div class="col-md-4 col-sm-12">
                    <label for="telefono" class="form-label"><b>Tel&eacute;fono</b></label>
                    <input type="text" class="form-control" id="telefono" value="{{$gps->telefono_gps}}" disabled placeholder="1234567890">
                </div>
            </div>
            ...
            <div class="row mt-3">
                <div class="col-md-4 col-sm-12">
                    ...
                    <input type="text" class="form-control" id="rfc" value="{{$gps->rfc_gps}}" disabled placeholder="XAXX010101000">
                </div>
                <div class="col-md-4 col-sm-12">
                    <label for="correoContacto" class="form-label"><b>Correo contacto</b></label>
                    <input type="email" class="form-control" id="correo_gps" value="{{$gps->correo_gps}}" disabled placeholder="empresa@email.com">
                </div>
                <div class="col-md-4 col-sm-12">
                    <label for="calle" class="form-label"><b>Calle</b></label>
                    <input type="text" class="form-control" id="calle" value="{{$gps->calle_gps}}" disabled placeholder="Nombre de la calle">
                </div>
            </div>
            ...
            <div class="row mt-3">
                <div class="col-md-4 col-sm-12">
                    ...
                    <input type="number" class="form-control" id="numExterior" value="{{$gps->n_exterior_gps}}" disabled placeholder="Número exterior">
                </div>
                <div class="col-md-4 col-sm-12">
                    <label for="colonia" class="form-label"><b>Colonia</b></label>
                    <input type="text" class="form-control" id="colonia" value="{{$gps->colonia_gps}}" disabled placeholder="Nombre de la colonia">
                </div>
                <div class="col-md-4 col-sm-12">
            ...
            <div class="row mt-3 mb-3">
                ...
                <div class="col-md-4 col-sm-12">
                    ...
                    <input type="text" class="form-control" id="cp" value="{{$gps->cp_gps}}" disabled placeholder="00000">
                </div>
            ...
            <div class="row mt-3 mb-3">
                <div class="col-12">
                    ...
                    <textarea class="form-control" name="observacion_gps" id="" cols="5" rows="5" disabled>{{$gps->observacion_gps}}</textarea>
                </div>
            </div>
            <hr>
            ...
            <div class="d-flex justify-content-center mt-3 gap-3">
                ...
                <a href="{{ route('gps.edit',$gps->id_gps) }}" class="btn btn-enviar">Editar</a>
            </div>
        </div>
    </div>
</div>
