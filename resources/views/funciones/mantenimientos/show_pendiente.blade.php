...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="card shadow-md mt-4 border-0 p-2">
            <div class="card-body">
                <form action="{{ route('mantenimientos/seguimiento/update') }}" class="needs-validation" novalidate method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                ...
                {{---------------------boton toogle------------------------}}
                    <div class="col-md-4 mt-4">
                        ...
                        <div class="input-group mb-3">
                            ...
                            @else
                                <label class="switch">
                                    <input type="checkbox" id="pagado" name="estatus_pago" disabled>
                                    <span class="slider round"></span>
                                </label>
                ...
                {{-----------------------------------------------------}}
                    ...
                    <div class="d-flex justify-content-center gap-4 mt-4">
                        ...
                        <button type="button" class="btn btn-pendiente" disabled>Pendiente de autorización</button>
                    </div>
                </form>
            </div>
        </div>
