...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="card shadow-md mt-4 border-0 p-2">
            <div class="card-body">
                <form action="{{ route('mantenimientos/seguimiento/store') }}" class="needs-validation" novalidate method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-md-4 mt-4">
                            <input type="text" value="{{ $info_mantenimiento[0]->id_citas_mantenimiento }}" name="id_citas_mantenimiento" hidden>
                            <input type="text" name="id_unidad" value="{{ $info_mantenimiento[0]->id_unidad }}" id="" hidden>
                        ...
                        <div class="col-md-4 mt-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="datepicker form-control" autocomplete="off" value="{{ $info_mantenimiento[0]->fecha_mantenimiento }}" placeholder="dd/mm/aaaa" readonly>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-4 mt-4">
                            <div class="form-group">
                                ...
                                <input type="file" name="a_cotizacion" id="archivo-input" accept="application/pdf" class="input-archivo cotizacion" disabled>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4 mt-4" id="factura">
                            <div class="form-group">
                                ...
                                <input type="file" name="a_factura" id="archivo-input" accept="application/pdf" class="input-archivo factura" disabled>
                            </div>
                        </div>
                {{---------------------boton toogle------------------------}}
                    <div class="col-md-4 mt-4">
                        ...
                        <div class="input-group mb-3">
                            <label class="switch">
                                <input type="checkbox" id="pagado" disabled>
                ...
                {{-----------------------------------------------------}}
                        <div class="col-md-12 mt-4">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <div class="form-floating">
                                            <textarea class="form-control" name="observaciones_call" placeholder="Observaciones" id="floatingTextarea" readonly>{{ $info_mantenimiento[0]->seguimiento_mantenimiento->observaciones_call }}</textarea>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <div class="form-floating">
                                            <textarea class="form-control" name="observaciones_call" placeholder="Observaciones" id="floatingTextarea" readonly>{{ $info_mantenimiento[0]->seguimiento_mantenimiento->observaciones_flising }}</textarea>
                    ...
                    <div class="d-flex justify-content-center gap-4 mt-4">
                        ...
                        {{--  <button type="submit" class="btn btn-enviar" id="basico">Guardar</button>  --}}
