...
@section('content')
    ...
    <div class="container-fluid mt-5">
        <div class="titulo-responsive">
            <label><a>Informe Egresos</a></label>
        </div>

        <div class="card border-0 p-2">
            <div class="card-body">
                {{-- <h5 class="title-orange titulo-pantcomp">Informe Egresos</h5> --}}
                <div class="row">
                    <div class="col-md-4">
