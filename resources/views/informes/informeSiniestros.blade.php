...
@section('content')
    ...
    <div class="container-fluid mt-5">
        ...
        <div class="titulo-responsive">
            <label><a>Informe Siniestros</a></label>
        </div>

        <div class="card border-0 p-2">
            <div class="card-body">
                {{-- <h5 class="title-orange titulo-pantcomp">Informe Siniestros</h5> --}}
                <div class="row">
                    <div class="col-md-3">
                    ...
                    <div class="col-md-3">
                        <label for="estatus" class="form-label"><b>Típo</b></label>
                        <select class="menu" name="estatus">
                            <option value="1">Seleccionar Típo</option>
                            <option value="2">Seguro de Flotillas</option>
                            <option value="3">Seguro de Riesgo</option>
                        </select>
                    </div>
